 ...
 */
class Version20160107212238 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE line (id INT AUTO_INCREMENT NOT NULL, number INT NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE securities (id INT AUTO_INCREMENT NOT NULL, line_id INT DEFAULT NULL, company_id INT DEFAULT NULL, currency_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, isin VARCHAR(12) NOT NULL, money_raised DOUBLE PRECISION NOT NULL, start_date DATE NOT NULL, maturity_date DATE DEFAULT NULL, coupon DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_A8210B242FE82D2D (isin), INDEX IDX_A8210B244D7B7542 (line_id), INDEX IDX_A8210B24979B1AD6 (company_id), INDEX IDX_A8210B2438248176 (currency_id), INDEX isin_idx (isin), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE securities ADD CONSTRAINT FK_A8210B244D7B7542 FOREIGN KEY (line_id) REFERENCES line (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE securities DROP FOREIGN KEY FK_A8210B244D7B7542');
